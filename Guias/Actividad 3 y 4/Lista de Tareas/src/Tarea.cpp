...
void Tarea::Cargar(){
    ...
    cout << "Cantidad de etiquetas a cargar: ";
    cin >> _cantEti;

    cin.ignore();
    for (int i=0 ; i < _cantEti; i++ ){
        cout << "Ingrese la etiqueta " << i+1 << " : ";
        getline(cin,_vecEtiquetas[i]);
...
string* Tarea::getVecEtiquetas(){return _vecEtiquetas;}
int Tarea::getCantEti(){return _cantEti;}
